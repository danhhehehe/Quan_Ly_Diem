...
<head>
    ...
    <link rel="icon" type="image/png" href="{{asset('/public/assets/img/logo1.jpg')}}">
    <title>
        Quản lý sinh viên
    </title>
    <!-- Fonts and icons -->
    ...
    <style>
        .btn.bg-gradient-primary {
            background-color:rgb(64, 143, 208) !important; /* Màu xanh */
            border-color:rgb(64, 143, 208) !important;
        }
    </style>
</head>
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="{{route('index')}}">
                <img src="{{asset('/public/assets/img/logo1.jpg')}}" class="navbar-brand-img h-100" alt="main_logo">
        ...
        <ul class="navbar-nav mb-3">
            @if(!auth()->check())
            <li class="nav-item">
                <a class="nav-link text-white bg-custom-blue" href="{{route('login')}}">
            ...
            @else
            <li class="nav-item">
                <a class="nav-link text-white bg-custom-blue" href="{{route('logout')}}">
                    <span class="nav-link-text ms-1">
                        Đăng xuất
                    </span>
                </a>
